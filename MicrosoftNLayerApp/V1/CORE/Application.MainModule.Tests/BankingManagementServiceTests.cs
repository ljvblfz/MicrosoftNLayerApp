...
namespace Application.MainModule.Tests
{
    ...
    public class BankingManagementServiceTests
    {
        ...
        public void PerformTransfer_Invoke_Test()
        {
            ...
            using (IBankingManagementService bankTransfersService = IoCFactory.Instance.CurrentContainer.Resolve<IBankingManagementService>())
            {
                ...
                //check balance 
                bankAccountService = IoCFactory.Instance.CurrentContainer.Resolve<IBankingManagementService>();
